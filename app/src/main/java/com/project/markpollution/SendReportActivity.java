...
import static com.project.markpollution.R.id.editTextSubmitTitle;
...
public class SendReportActivity extends AppCompatActivity implements OnMapReadyCallback, View.OnClickListener {
    ...
    private void initView() {
        ...
        mapFragment = (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.mapSubmit);
        storage = FirebaseStorage.getInstance();

        etTitle = (EditText) findViewById(editTextSubmitTitle);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(point).title("This is Pollution Point ")).showInfoWindow();
    ...
    public void onClick(View v) {
        if (v == btnSubmit) {
            if (etTitle.getText().toString().equals("") || etDesc.getText().toString().equals("")) {
                Toast.makeText(SendReportActivity.this, "Bạn cần nhập đầy đủ thông tin!", Toast.LENGTH_LONG).show();
            } else {
                showpDialog();

                StorageReference storeRef = storage.getReferenceFromUrl("gs://markpollution.appspot.com");
                StorageReference picRef = storeRef.child("images/IMG_"
                ...
                uploadTask.addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(SendReportActivity.this, "Upload image failure",
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        StringRequest strReq = new StringRequest(Request.Method.POST,
                                url_insert_pollutionPoint, new Response.Listener<String>() {
                            @Override
                            public void onResponse(String response) {
                            ...
                            @Override
                            public void onErrorResponse(VolleyError error) {
                                Toast.makeText(SendReportActivity.this, error.getMessage(),
                                        Toast.LENGTH_SHORT).show();
                                finish();
                            }
                        }) {
